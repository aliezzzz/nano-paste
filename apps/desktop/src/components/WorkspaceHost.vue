    ...
    <div class="hidden md:flex flex-col h-screen" id="workspace-desktop">
      <header class="relative z-[80] h-16 border-b border-slate-800/50 bg-slate-900/85 flex items-center justify-between px-4 sm:px-6 shrink-0">
        ...
        <div class="flex items-center gap-4">
          ...
          <button id="open-config-btn" type="button" title="连接配置" aria-label="连接配置" class="w-10 h-10 rounded-xl border border-slate-700/60 bg-slate-800/55 text-slate-300 hover:text-white hover:bg-slate-700/75 transition-colors flex items-center justify-center" @click="openConfig">
