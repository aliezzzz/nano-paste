...
const iconByKind: Record<FileKind, string> = {
  ...
  image: '<svg class="w-7 h-7" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="8" width="48" height="48" rx="12" fill="#47b75e"/><circle cx="24" cy="24" r="6" fill="#edfffb"/><path d="M14 46l12-12 8 8 6-5 10 9" fill="none" stroke="#edfffb" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
