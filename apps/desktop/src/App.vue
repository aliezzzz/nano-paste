...
async function handleItemAction(payload: { id: string; action: "copy" | "download" | "delete" | "favorite"; type: "text" | "file"; content?: string; fileId?: string; fileName?: string; isFavorite: boolean }): Promise<void> {
  ...
  <div class="app-root">
    <template v-if="!isAuthenticated">
      <section id="login-page" class="app-login-page">
        ...
        <button id="open-config-btn" type="button" title="连接配置" aria-label="连接配置" class="app-login-config-btn safe-top-offset" @click="openConfig">
